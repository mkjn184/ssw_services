...
<!--<![endif]-->
	<head>
		<meta charset="utf-8">
		<title>Service</title>
		<meta name="description" content="Service Company">
		<meta name="author" content="Service Company">
					...
					<div class="col-md-4">
						...
						<div class="header-left clearfix">
							...
							<div class="logo smooth-scroll">
								<a href="#banner"><img id="logo" src="<?php echo get_theme_file_uri('/assets/images/logo.png'); ?>" alt="Worthy"></a>
							</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-6">
								<img src="<?php echo get_theme_file_uri('/assets/images/section-image-1.png'); ?>" alt="">
								<div class="space"></div>
							</div>
							<div class="col-md-6">
					...
					<div class="col-md-12">
						...
						<div class="isotope-container row grid-space-20">
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									<div class="overlay-container">
										<img src="<?php echo get_theme_file_uri('/assets/images/portfolio-1.jpg'); ?>" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item app-development">
								<div class="image-box">
									<div class="overlay-container">
										<img src="<?php echo get_theme_file_uri('/assets/images/portfolio-2.jpg'); ?>" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									<div class="overlay-container">
										<img src="<?php echo get_theme_file_uri('/assets/images/portfolio-3.jpg'); ?>" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item site-building">
								<div class="image-box">
									<div class="overlay-container">
										<img src="<?php echo get_theme_file_uri('/assets/images/portfolio-4.jpg'); ?>" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item app-development">
								<div class="image-box">
									<div class="overlay-container">
										<img src="<?php echo get_theme_file_uri('/assets/images/portfolio-5.jpg'); ?>" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									<div class="overlay-container">
										<img src="<?php echo get_theme_file_uri('/assets/images/portfolio-6.jpg'); ?>" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item site-building">
								<div class="image-box">
									<div class="overlay-container">
										<img src="<?php echo get_theme_file_uri('/assets/images/portfolio-7.jpg'); ?>" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									<div class="overlay-container">
										<img src="<?php echo get_theme_file_uri('/assets/images/portfolio-8.jpg'); ?>" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									<div class="overlay-container">
										<img src="<?php echo get_theme_file_uri('/assets/images/portfolio-9.jpg'); ?>" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item site-building">
								<div class="image-box">
									<div class="overlay-container">
										<img src="<?php echo get_theme_file_uri('/assets/images/portfolio-10.jpg'); ?>" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									<div class="overlay-container">
										<img src="<?php echo get_theme_file_uri('/assets/images/portfolio-11.jpg'); ?>" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item app-development">
								<div class="image-box">
									<div class="overlay-container">
										<img src="<?php echo get_theme_file_uri('/assets/images/portfolio-12.jpg'); ?>" alt="">
			...
			<div class="container object-non-visible" data-animation-effect="fadeIn">
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="media testimonial">
							<div class="media-left">
								<img src="<?php echo get_theme_file_uri('/assets/images/testimonial-3.png'); ?>" alt="">
							</div>
							<div class="media-body">
						...
						<div class="row">
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="<?php echo get_theme_file_uri('/assets/images/client-1.png'); ?>" alt="client">
								</div>
							</div>
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="<?php echo get_theme_file_uri('/assets/images/client-2.png'); ?>" alt="client">
								</div>
							</div>
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="<?php echo get_theme_file_uri('/assets/images/client-3.png'); ?>" alt="client">
								</div>
							</div>
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="<?php echo get_theme_file_uri('/assets/images/client-4.png'); ?>" alt="client">
								</div>
							</div>
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="<?php echo get_theme_file_uri('/assets/images/client-5.png'); ?>" alt="client">
								</div>
							</div>
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="<?php echo get_theme_file_uri('/assets/images/client-6.png'); ?>" alt="client">
								</div>
							</div>
						</div>
					</div>
